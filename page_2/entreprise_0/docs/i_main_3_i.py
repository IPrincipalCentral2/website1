...
class ImageFolderApp(QWidget):
    def __init__(self):
        ...
        self.image1_browse.clicked.connect(lambda: self.browse_file(self.image1_edit, 1))
        self.image1_edit.editingFinished.connect(lambda: self.update_preview(1))
        ...
        self.image2_browse.clicked.connect(lambda: self.browse_file(self.image2_edit, 2))
        self.image2_edit.editingFinished.connect(lambda: self.update_preview(2))
        ...
        self.preview_label1.setFixedSize(300, 200)
        self.preview_label1.setStyleSheet("border: 1px solid gray; background-color: #f8f8f8;")
        self.preview_label1.setAlignment(Qt.AlignCenter)

        self.preview_label2 = QLabel()
        self.preview_label2.setFixedSize(300, 200)
        self.preview_label2.setStyleSheet("border: 1px solid gray; background-color: #f8f8f8;")
        ...
        preview_row.addWidget(self.preview_label1)
        preview_row.addWidget(self.preview_label2)
    ...
    def update_preview(self, image_number):
        """تحديث معاينة الصورة عند اختيارها"""
        edit = self.image1_edit if image_number == 1 else self.image2_edit
        label = self.preview_label1 if image_number == 1 else self.preview_label2
