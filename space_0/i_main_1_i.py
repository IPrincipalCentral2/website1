...
print(f"1 . from => {i_amount_of_from_0_i} {from_currency} . to ==> {i_amount_0_i} {currency} .")



i_result_0_i = i_amount_of_from_0_i * exchange_rate_2

print(f"2 . i_amount_of_from_0_i = {i_amount_of_from_0_i} {from_currency} . i_result_0_i = {i_result_0_i} {currency} .")
